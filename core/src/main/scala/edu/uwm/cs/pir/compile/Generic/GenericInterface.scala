...
object GenericInterface {
  ...
  trait GenericLoad[Out <: IFeature] extends Serializable with GenericInfo {
  ...
  trait GenericIndex[In <: IFeature, Index <: IIndex] extends Serializable with GenericInfo {
  ...
  trait GenericBasicIndex[In <: IFeature, Index <: IIndex] extends Serializable with GenericInfo {
  ...
  trait GenericProj[In <: IFeature, Out <: IFeature] extends Serializable with GenericInfo {
    def apply(in: In): Out
    def setIndex(index: IIndex): Unit
    def setModel(model: IModel): Unit
  }

  trait GenericProjWithIndex[In <: IFeature, Out <: IFeature, Index <: IIndex] extends GenericProj[In, Out] with Serializable with GenericInfo {
    var index: Option[Index] = None
    def apply(in: In): Out
  }
  
  trait GenericProjWithBasicIndex[In <: IFeature, Out <: IFeature, Index <: IIndex] extends GenericProj[In, Out] with Serializable with GenericInfo {
    var index: Option[Index] = None
    def apply(in: In): Out
  }

  trait GenericCompose[In <: IFeature, Compose <: ICompose] extends Serializable with GenericInfo {
    def apply(in: List[List[In]]): Compose
  }

  trait GenericTrain[In <: IFeature, Model <: IModel] extends Serializable with GenericInfo {
  ...
  trait GenericTrain2[In1 <: IFeature, In2 <: IFeature, Model <: IModel] extends Serializable with GenericInfo {
  ...
  trait GenericProjWithModel[In <: IFeature, Out <: IFeature, Model <: IModel] extends GenericProj[In, Out] with Serializable with GenericInfo {
